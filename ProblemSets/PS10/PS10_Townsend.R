...
top_tree  <- show_best(rec_res, metric = "accuracy")
best_tree <- select_best(rec_res, metric = "accuracy")
finaldec_tree <- finalize_workflow(Tree_wf,best_tree)
...
# what is the best value?
top_nnet_result  <- show_best(res_nnet, metric = "accuracy")
best_nnet_result <- select_best(res_nnet, metric = "accuracy")
final_nnet_result <- finalize_workflow(wf_nnet,best_nnet_result)
...
# what is the best value?
top_knn  <- show_best(res_knn, metric = "accuracy")
best_knn <- select_best(res_knn, metric = "accuracy")
...
# what is the best value?
top_svm  <- show_best(res_svm, metric = "accuracy")
best_svm <- select_best(res_svm, metric = "accuracy")
final_svm <- finalize_workflow(wf_svm,best_svm)
